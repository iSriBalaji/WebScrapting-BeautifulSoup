...
csv_path = os.path.join(path,"solarProjectData.csv")
...
csv_writer.writerow(['Company Name','Phone Number','Website','Country'])
csv_file.close()
    ...
    for j in range(1,pages+1):
        ...
        for tr in fin.find_all('tr'):
            ...
            try:
                ...
                pass
            try:
                csv_writer.writerow([company,contact_no,website,i])
            except:
                csv_writer.writerow([company.encode(sys.stdout.encoding, errors='replace'),contact_no.encode(sys.stdout.encoding, errors='replace'),website.encode(sys.stdout.encoding, errors='replace'),i.encode(sys.stdout.encoding, errors='replace')])
